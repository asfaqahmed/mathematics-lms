              ...
              >
                ...
                {activeTab === 'maintenance' && (
                  <div className="space-y-6">
                        ...
                        <div className="flex items-start space-x-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1">
                              ...
                              onChange={(e) => updateNestedSetting('payment', 'payhere', 'merchantId', e.target.value)}
                              className="input w-full"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <input
                              type="password"
                              value={settings.payment.payhere.merchantSecret}
                              onChange={(e) => updateNestedSetting('payment', 'payhere', 'merchantSecret', e.target.value)}
                              className="input w-full"
                            />
                          </div>
                          ...
                          <div className="md:col-span-2">
                            <label className="flex items-center space-x-2">
                              <input
                                type="checkbox"
                                checked={settings.payment.payhere.sandbox}
                                onChange={(e) => updateNestedSetting('payment', 'payhere', 'sandbox', e.target.checked)}
                                className="w-4 h-4"
                              />
                              <span className="text-sm text-gray-300">Sandbox Mode (Test Environment)</span>
                            </label>
                          </div>
                        </div>
                      )}
                    ...
                    <div className="p-4 bg-dark-700 rounded-lg">
                      <div className="flex items-center justify-between mb-4">
                        <h4 className="font-semibold text-white">Stripe Configuration</h4>
                        <button
                          onClick={() => updateNestedSetting('payment', 'stripe', 'enabled', !settings.payment.stripe.enabled)}
                          className={`${settings.payment.stripe.enabled ? 'text-green-400' : 'text-gray-400'}`}
                        >
                          {settings.payment.stripe.enabled ? <FiToggleRight size={24} /> : <FiToggleLeft size={24} />}
                        </button>
                      </div>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => updateNestedSetting('payment', 'stripe', 'publishableKey', e.target.value)}
                              className="input w-full font-mono text-xs"
                            />
                          </div>
